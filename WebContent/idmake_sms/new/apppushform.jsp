	...
	%>
							...
							<tr id="tr_refuserid" style="display:<%if (isChk.equals("Y") && "".equals(refuserid2)) {%>none<%}else{%><%}%>;">
								<td height=25 colspan="2">
									...
									<span style="display:inline-block; width:123px; font-size:8pt; padding-bottom:2px; margin-top:10px;">대리자 사번 :</span> <input type="text" name="refuserid" value="<%=refuserid%>" size="8" class="input" style="width:93px; margin-top:10px;"  <%if (empno.equals("ex099129")) {%><%}else{%> onkeyup="CheckEmpno(document.data.refuserid);"<%}%> /> 
