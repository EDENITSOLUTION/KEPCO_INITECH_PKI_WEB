	...
	%>
							...
							<tr id="tr_refuserid" style="display:<%if (isChk.equals("Y") && "".equals(refuserid2)) {%>none<%}else{%><%}%>;">
								<td height=25 colspan="2">
									...
									<br />
									<span style="display:inline-block; width:123px; font-size:8pt; padding-bottom:2px;"><%=userName%>님의 비밀번호 :</span> <input type="password" name="orguserpw" value="" class="input" style="width:93px; margin-top:5px;" />
