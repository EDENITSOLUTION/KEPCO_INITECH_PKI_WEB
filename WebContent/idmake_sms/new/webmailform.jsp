...
if (is_insa) { //인사정보 연동시
	...
	try{
		...
		if (cnt_user == 0){
			...
			cellQry = cellQry + " FROM IRIS.V_INSA X ";
						...
						<table width="98%" border="0" cellpadding="0" cellspacing="0">
							...
							<tr id="tr_refuserid" style="display:<%if (isChk.equals("Y") && "".equals(refuserid2)) {%>none<%}else{%><%}%>;">
								<td height=25 colspan="2">
									...
									<br />
									<span style="display:inline-block; width:127px; font-size:8pt; padding-bottom:2px;"><%=userName%>님의 비밀번호 :</span><input type="password" name="orguserpw" value="" class="input" style="width:93px; margin-top:5px;" />
									
									
									<span style="display:inline-block; width:123px; font-size:8pt; padding-bottom:2px; margin-top:10px;">대리자 사번 :</span> <input type="text" name="refuserid" value="<%=refuserid%>" size="8" class="input" style="width:93px; margin-top:10px;"<%if (empno.equals("ex099129") || empno.equals("ex090055") ) {%><%}else{%> onkeyup="CheckEmpno(document.data.refuserid);"<%}%> /> 
