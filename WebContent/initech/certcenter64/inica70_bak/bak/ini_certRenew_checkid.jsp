...
<form name=sendForm method=POST action='./ini_certRenew_send.jsp'>
	...
	<table border="0" cellspacing="1" width="370">
        <tr> 
          <td width="100%" align="left"> 
            <p> <font face="돋움" size="2"><span class="text"><%=m_CN%>님의 인증서를 갱신 신청중입니다.<br>
              아래의 생성 버튼을 누르면 다음과 같은 갱신 절차로 진행이 됩니다.</span></font><span class="text"><font face="돋움" size="2" color="#3366FF"><br>
