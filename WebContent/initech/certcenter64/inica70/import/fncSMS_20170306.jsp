 ...
 public String sendSMS(String strCertGb, String userId, String strTmid) {
        ...
        if (resultCd.equals("SEND-YES")) {
                ...
                if (strCertGb.equals("certNew")){ //인증서 발급 후
                        ...
                        try{
                                ...
                                if (cnt_log_user == 0){
                                        ...
                                        if (strUserid.trim().equals(strRefuserid.trim())){
                                                strMsgText = "[인터넷망] " + userName + "("+ userId +")님의 인증서 발급이 완료되었습니다.";
                                                strMsgText1 = strMsgText;
                                                strMakingText = Make_SMS_MSG(strMyPhoneNum, strMsgText, userId);
                                                strMakingText1 = strMakingText;
                                        }
                                        else{
                                                strMsgText = "[인터넷망] " + userName + "("+ userId +")님의 인증서 대리발급이 완료되었습니다.";
                                                strMsgText1 = "[인터넷망] " + userName + "("+ userId +")님의 인증서 대리발급이 완료되었습니다.";
                                                strMakingText = Make_SMS_MSG(strMyPhoneNum, strMsgText, userId);
                        ...
                        userTmid = "";
                        userSmsSeq = "";
                        strMsgText = "[인터넷망] " + userName + "("+ userId +")님의 인증서 폐기가 완료되었습니다.";
                        strMakingText = Make_SMS_MSG(strMyPhoneNum, strMsgText, userId);
                ...
                if (strUserid.trim().equals(strRefuserid.trim())){
   						 ...
   						 System.out.println("===================================================================="); 
						 System.out.println("대리 발급 디버깅 정보 시작"); 
						 System.out.println("===================================================================="); 
						 System.out.println("[ 1. strMakingText1 ]" + strMakingText1);
					
                         RETURNCODE = sms.SendSMS(SENDIP, SENDPORT, strMakingText1);
                         RETURNCODE = RETURNCODE.trim();
                         RETURNMSG = rtnMessage(RETURNCODE);
						 
						 System.out.println("[ 2. RETURNCODE ]" + RETURNCODE);
                         System.out.println("[ 3. RETURNMSG ]" + RETURNMSG);
                         System.out.println("===================================================================="); 
                         System.out.println("대리 발급 디버깅 정보 종료"); 
                         System.out.println("===================================================================="); 
