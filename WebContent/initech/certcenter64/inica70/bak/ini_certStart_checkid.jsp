...
<head>
	...
	function CheckSendForm(readForm, sendForm)
	{
		...
		alert("인증서 효력회복 신청이 취소 되었습니다.");
		return false;
	}

	function ViewMsg()
	{
		var msg = "인증서버에서 인증서를 효력회복중 입니다. 잠시만 기다리십시요.";
		setMsg(msg, 0, 200);
		showMsg();
	}
...
<table width="570" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr> 
    <td align="center">
<form name=sendForm method=POST action='./ini_certStart_send.jsp'>
      ...
      <table border="0" cellspacing="1" width="370">
        <tr> 
          <td width="100%" align="left" class="text"> 
              <%=m_ID%>님의 인증서를 효력회복 신청중입니다.<br>
              아래의 효력회복 버튼을 누르면 <%=m_ID%>님의 인증서가 효력회복됩니다.<br>
          </td>
        </tr>
        <tr> 
          <td height="27">&nbsp;</td>
