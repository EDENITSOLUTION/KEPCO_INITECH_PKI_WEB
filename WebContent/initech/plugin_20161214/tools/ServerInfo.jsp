...
<%
	...
	Date currentTime = new Date();				// ÇöÀç ½Ã°£
...
<%
{
	...
	for (int i=0; i<clasName.length; i++) {
		...
		if (clasUrl != null) {
			...
			sb_crypto.append("<br>&nbsp;&nbsp;&nbsp;");
			sb_crypto.append("<font face='µ¸¿ò' color='#2F83C3'><span style='font-size:8pt;'>");
...
<%
{
	...
	for (int i=0; i<clasName.length; i++) {
		...
		if (clasUrl != null) {
			...
			sb_common.append("<br>&nbsp;&nbsp;&nbsp;");
			sb_common.append("<font face='µ¸¿ò' color='#2F83C3'><span style='font-size:8pt;'>");
...
<%
{
	...
	for (int i=0; i<clasName.length; i++) {
		...
		if (clasUrl != null) {
			...
			sb_pkg.append("<br>&nbsp;&nbsp;&nbsp;");
			sb_pkg.append("<font face='µ¸¿ò' color='#2F83C3'><span style='font-size:8pt;'>");
...
<%
{
	...
	for (int i=0; i<clasName.length; i++) {
		...
		if (clasUrl != null) {
			...
			sb_ocsp.append("<br>&nbsp;&nbsp;&nbsp;");
			sb_ocsp.append("<font face='µ¸¿ò' color='#2F83C3'><span style='font-size:8pt;'>");
...
<%
{
	...
	for (int i=0; i<clasName.length; i++) {
		...
		if (clasUrl != null) {
			...
			sb_cs.append("<br>&nbsp;&nbsp;&nbsp;");
			sb_cs.append("<font face='µ¸¿ò' color='#2F83C3'><span style='font-size:8pt;'>");
...
<%
{
	...
	for (int i=0; i<clasName.length; i++) {
		...
		if (clasUrl != null) {
			...
			sb_plus.append("<br>&nbsp;&nbsp;&nbsp;");
			sb_plus.append("<font face='µ¸¿ò' color='#2F83C3'><span style='font-size:8pt;'>");
...
<table border='0' cellpadding='2' cellspacing='0' width='749'>
    <tr>
		<td colspan='2'><p align='left'><a href="javascript:location.reload();">»õ·Î°íÄ§</a></p></td>
	</tr>
    <tr>
