...
3. update 2005/11/01 young@initech.com
 ...
 4. updata 2013/10/02 youltan.sung@initech.com
 - IE 11 호환성 처리  추가
********************************************************************/

var baseURL				= "http://" + window.location.host + "/initech/plugin64/";

var DownBaseURL			= "http://" + window.location.host + "/initech/plugin64/";

var InstallModuleURL	= DownBaseURL + "dll/INIS60.vcs"; 
var InstallModuleURL_noExt	= baseURL + "dll/INIS60_noExt.vcs";
var iePackageURL		= DownBaseURL + "down/INIS60.cab"; 
...
var ieVersion			= "6,4,0,65"; 
var nsVersion			= ieVersion;

// add 2004/09/01 wakano@initech.com INISAFEWeb.html 사용시 사용)
var InstallPluginURL	= "http://" + window.location.host + "/initech/plugin64/site/install.html";
