...
public class _dbtest__jsp extends com.caucho.jsp.JavaPage
{
    ...
    throws Throwable
  {
	...
	try{
		...
		rs = stmt.executeQuery("select serial from LDAP_INFO");
		
		//List results
		while(rs.next()) {
			out.print( "serial : " );
			out.print( rs.getString("serial") + "<br>" );
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("dbtest.jsp"), 1670514845099792063L, true);
    _caucho_depends.add(depend);
  }
