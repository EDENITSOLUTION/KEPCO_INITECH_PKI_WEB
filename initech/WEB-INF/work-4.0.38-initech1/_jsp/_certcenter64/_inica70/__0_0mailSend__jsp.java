...
public class __0_0mailSend__jsp extends com.caucho.jsp.JavaPage
{
    ...
    throws Throwable
  {
    ...
    out.print((request.getParameter("didx")));
    out.write(_jsp_string1, 0, _jsp_string1.length);
    out.print((request.getParameter("usb")));
    out.write(_jsp_string1, 0, _jsp_string1.length);
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("certcenter64/inica70/__mailSend.jsp"), 5144772391908993447L, true);
    _caucho_depends.add(depend);
  }
