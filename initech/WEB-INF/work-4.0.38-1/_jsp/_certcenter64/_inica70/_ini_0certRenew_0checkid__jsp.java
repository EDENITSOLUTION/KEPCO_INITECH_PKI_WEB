...
public class _ini_0certRenew_0checkid__jsp extends com.caucho.jsp.JavaPage
{
...
if (m_IniErrCode == null) 
{
	if (m_bDebug) IniDebug.println(m_ID, m_How + " : host(DB) connect start ...");
	...
	try {
		...
		if (m_bDebug) IniDebug.println(m_ID, m_How + " : m_certserial: " + m_certserial);
	...
	if (m_bDebug) IniDebug.println(m_ID, m_How + " : host(DB) connect end ...");
}
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("certcenter64/inica70/ini_certRenew_checkid.jsp"), -5555286195238058234L, true);
    _caucho_depends.add(depend);
    ...
    _caucho_depends.add(depend);
    depend = new com.caucho.vfs.Depend(appDir.lookup("certcenter64/inica70/import/inica70_db_check.jsp"), -7790548376586263925L, true);
    _caucho_depends.add(depend);
