...
public class _ini_0certRevoke_0send__jsp extends com.caucho.jsp.JavaPage
{
     ...
     if (m_IniErrCode == null) 
{
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("certcenter64/inica70/ini_certRevoke_send.jsp"), 3689224625634366570L, true);
    _caucho_depends.add(depend);
    depend = new com.caucho.vfs.Depend(appDir.lookup("certcenter64/inica70/import/iniplugin_init.jsp"), 6054584604837940715L, true);
    _caucho_depends.add(depend);
    depend = new com.caucho.vfs.Depend(appDir.lookup("certcenter64/inica70/import/inica70_init.jsp"), 4108511886007058044L, true);
    _caucho_depends.add(depend);
    depend = new com.caucho.vfs.Depend(appDir.lookup("certcenter64/inica70/import/inica70_ca_send.jsp"), 1487023050476228154L, true);
    _caucho_depends.add(depend);
